...
exports.GalacticCalculator = undefined;
...
var GalacticCalculator = exports.GalacticCalculator = function () {
  ...
  _createClass(GalacticCalculator, [{
    ...
    value: function yearsToSeconds(integer) {
      var output = _moment2.default.duration(integer, 'years').asSeconds();
      console.log(output);
      return output;
    }
  }, {
    ...
    value: function secBetween(dateA, dateB) {
      var momentA = (0, _moment2.default)(dateA);
      var momentB = (0, _moment2.default)(dateB) || (0, _moment2.default)();
...
var _galacticCalculator = require('./../js/galactic-calculator.js');
